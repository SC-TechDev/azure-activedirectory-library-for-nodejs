...
util.setupExpectedOnBehalfOfTokenRequestResponse = function(httpCode: any, userAccessToken: any, returnDoc: any, authorityEndpoint: any) {
  var authEndpoint: any = authorityEndpoint || parameters.authority;
